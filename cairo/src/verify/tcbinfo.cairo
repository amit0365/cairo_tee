...
pub fn validate_tcbinfov2(tcbinfov2: @TcbInfoV2, sgx_signing_cert: @X509CertificateData, current_time: u64) -> bool {
...
pub fn validate_tcbinfov3(tcbinfov3: @TcbInfoV3, sgx_signing_cert: @X509CertificateData, current_time: u64) -> bool {
    // get tcb_info_root time
